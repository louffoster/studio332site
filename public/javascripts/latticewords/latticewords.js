...
class Latticewords extends Phaser.Scene {
   constructor ()   {
      super({ key: 'latticewords' });
   }
   preload () {
      this.load.image('grid-bkg', 'images/latticewords/grid-bkg.png');
      this.load.spritesheet('pause', 'images/latticewords/pause.png',  { frameWidth: 32, frameHeight: 32 });
      this.load.image('grid', 'images/latticewords/grid.png');
      this.load.image('pause-bkg', 'images/latticewords/pause=bkg.png');
      this.load.image('left', 'images/latticewords/left.png');
      this.load.image('right', 'images/latticewords/right.png');
      this.load.image('up', 'images/latticewords/up.png');
      this.load.image('down', 'images/latticewords/down.png');
      this.load.image('clear', 'images/latticewords/clear.png');
      this.load.image('check', 'images/latticewords/check.png');
   }
